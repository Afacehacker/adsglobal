...
const seedData = async () => {
  try {
    ...
    await Product.create([
      ...
      {
        name: 'Luxury Leather Handbag & Matching Clutch Set',
        sku: 'PRD-US-FAS-43B',
        category: catBeauty._id,
      ...
      },
      {
        ...
        sku: 'PRD-US-FAS-43F',
        category: catBeauty._id,
        description: 'Iconic basketball sneaker featuring premium leather uppers, encapsulated Air-Sole unit, and signature Wings logo.',
      ...
      {
        name: 'Naija Crunchy Snacks Variety Pack',
        sku: 'PRD-GRO-46B',
        category: catFood._id,
        description: 'Assorted West African snacks including spicy plantain chips, chin chin, and seasoned roasted peanuts.',
        short_description: 'Naija Crunchy Snacks Variety Pack.',
        price_coins: 21375,
      ...
      {
        name: 'Egusi & Ogbono Soup Ingredients Mega Pack',
        sku: 'PRD-GRO-46C',
        category: catFood._id,
        description: 'Premium ground melon seeds (Egusi), wild mango seeds (Ogbono), dried crayfish, stockfish flakes & pepper mix.',
        short_description: 'Egusi & Ogbono Soup Ingredients Mega Pack.',
        price_coins: 25125,
